...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { full_description: @progress.full_description, short_description: @progress.short_description }
    end
  ...
  test "should update progress" do
    put :update, id: @progress, progress: { full_description: @progress.full_description, short_description: @progress.short_description }
    assert_redirected_to progress_path(assigns(:progress))
  end

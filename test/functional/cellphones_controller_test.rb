...
class CellphonesControllerTest < ActionController::TestCase
  ...
  test "should create cellphone" do
    assert_difference('Cellphone.count') do
      post :create, cellphone: { accessories: @cellphone.accessories, color: @cellphone.color, comments: @cellphone.comments, condition: @cellphone.condition, failure: @cellphone.failure, imei: @cellphone.imei, ope_system: @cellphone.ope_system }
    end
  ...
  test "should update cellphone" do
    put :update, id: @cellphone, cellphone: { accessories: @cellphone.accessories, color: @cellphone.color, comments: @cellphone.comments, condition: @cellphone.condition, failure: @cellphone.failure, imei: @cellphone.imei, ope_system: @cellphone.ope_system }
    assert_redirected_to cellphone_path(assigns(:cellphone))
  end
